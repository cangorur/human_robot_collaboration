...
public:
	...
	virtual std::vector<std::pair<std::string, double>> Update(int action, OBS_TYPE obs) = 0;
...
public:
	...
	virtual std::vector<std::pair<std::string, double>> Update(int action, OBS_TYPE obs);
