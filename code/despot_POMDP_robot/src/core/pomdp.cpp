...
bool DSPOMDP::StepManual(State& state, double random_num, int new_state, int action, double& reward,
	OBS_TYPE& obs) const {
	return StepManual(state, random_num, new_state, action, reward, obs);
}
