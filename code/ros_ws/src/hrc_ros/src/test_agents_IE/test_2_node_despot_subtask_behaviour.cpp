...
int main(int argc, char **argv) {
	...
	string test_outcome = "failure";
		...
		cout << " TaskManager_status (received from Despot): " << test_agent.Despot_global_task_status << endl;
		cout << endl << endl << " 4th subtask success issued -> please check the state of the Despot " << endl << endl; 
		cout << "Press any key to continue"  << endl;  
		cin.get(); 
		...
		cout << " TaskManager_status (received from Despot): " << test_agent.Despot_global_task_status << endl;
		cout << endl << endl << " 5th subtask success issued -> please check the state of the Despot -> should stop and be in global success " << endl << endl; 
		cout << "Press any key to continue"  << endl;  
		cin.get(); 
		...
		test_object = 2;  // test_object that is published by the observationagent 	
		test_tray   = 5;  // test_tray is published as the tray the observationagent has observed 
		correct_tray = 3; // this is the correct tray according to the IE_task_config.json file 
		...
		cout << " TaskManager_status (received from Despot): " << test_agent.Despot_global_task_status << endl;
		cout << endl << endl << " 3rd subtask fail issued -> please check the state of the Despot " << endl << endl; 
		cout << "Press any key to continue"  << endl;  
		cin.get(); 
