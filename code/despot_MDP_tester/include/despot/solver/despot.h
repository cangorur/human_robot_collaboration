...
public:
	...
	void Update(std::string new_state, int action, OBS_TYPE obs);
	
	std::vector<std::pair<std::string, double>> belief_distr;
	std::vector<std::pair<std::string, double>> GetBeliefDistribution(void);
