...
public:
	...
	void webSocketClient(int action, std::string state, double reward, double discounted_reward);
	bool RunStep(int step, int round, int new_state, int observed_state);
	bool RunInitial();
