...
public:
	 ...
	 */
	virtual void Update(std::string new_state, int action, OBS_TYPE obs);
	
	/*
	 * Return the up-to-date belief distribution (from DESPOT type only)
	 */
	virtual std::vector<std::pair<std::string, double>> GetBeliefDistribution(void) = 0;
