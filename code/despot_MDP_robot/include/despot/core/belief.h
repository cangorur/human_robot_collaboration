...
public:
	...
	virtual std::vector<std::pair<std::string, double>> Update(std::string new_state, int action, OBS_TYPE obs) = 0;
...
public:
	...
	virtual std::vector<std::pair<std::string, double>> Update(std::string new_state, int action, OBS_TYPE obs);
